              ...
              {filteredQuotes.map((quoteData, index) => (
                <div key={index} style={{ backgroundColor: 'white', borderRadius: '20px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '10px' }}>
                    <p style={{ marginBottom: '5px', fontSize: '14px', fontWeight: 'bold', lineHeight: '1.2', maxHeight: '60px', overflow: 'hidden' }}
            ...
            {selectedQuote && (
              <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 9999 }}>
                <div style={{
                  ...
                  <p style={{ marginBottom: '5px', fontSize: '20px', fontWeight: 'bold' }}>{selectedQuote.quote}</p>
